...
import 'package:dashboard_app/weather/api/weather_icons.dart';
import 'package:dashboard_app/weather/model/weather.dart';

// Weather API key
class WeatherApi {
  static const apiKey = '3e818b5e30626215d9f2a7a11e2bff2f';

  // search city using openweathermap API
  ...
  /// Get Weather data using Api: https://openweathermap.org/current
